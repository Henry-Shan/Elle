...
export const metadata: Metadata = {
  ...
  description: "Learn about Elle AI's comprehensive security measures and data protection policies.",
};
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h1 className="text-5xl font-bold text-gray-900 mb-6">Security & Privacy</h1>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8">
              ...
              <p className="text-gray-600">
                We never use your data for training our models. Your conversations remain private and confidential.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8">
              ...
              <p className="text-gray-600">
                Our infrastructure is hosted on secure, SOC 2 compliant cloud providers with 99.9% uptime.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8">
              ...
              <p className="text-gray-600">
                We comply with GDPR, CCPA, and other major privacy regulations to protect your rights.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8">
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-xl font-semibold text-gray-900">Team Security</h3>
              </div>
              <p className="text-gray-600">
                All team members undergo background checks and security training to maintain the highest standards.
              </p>
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8 mb-12">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div>
                <h3 className="text-xl font-semibold text-gray-900 mb-4">Security Standards</h3>
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8 mb-12">
            <h2 className="text-3xl font-semibold text-gray-900 mb-8 text-center">How We Handle Your Data</h2>
            <div className="space-y-6">
              <div>
                <h3 className="text-xl font-semibold text-gray-900 mb-2">Data Collection</h3>
                <p className="text-gray-700">
                  We only collect the data necessary to provide our AI services. This includes your conversations, 
                  preferences, and usage patterns. We never collect sensitive personal information without your explicit consent.
                </p>
              </div>
              <div>
                <h3 className="text-xl font-semibold text-gray-900 mb-2">Data Usage</h3>
                <p className="text-gray-700">
                  Your data is used solely to provide and improve our AI services. We do not sell, rent, or share 
                  your personal data with third parties for marketing purposes.
                </p>
              </div>
              <div>
                <h3 className="text-xl font-semibold text-gray-900 mb-2">Data Retention</h3>
                <p className="text-gray-700">
                  We retain your data only as long as necessary to provide our services. You can request data 
                  deletion at any time, and we will comply within 30 days.
                </p>
              </div>
            </div>
          </div>
          ...
          {/* Contact Section */}
          <div className="bg-white rounded-2xl shadow-lg p-8">
            <h2 className="text-3xl font-semibold text-gray-900 mb-8 text-center">Security Questions?</h2>

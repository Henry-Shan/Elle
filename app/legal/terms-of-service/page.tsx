          ...
          <div className="bg-white rounded-2xl shadow-lg p-8 space-y-8">
            <section>
              ...
              <p className="text-gray-700 leading-relaxed">
                By accessing and using Elle AI services, you accept and agree to
            ...
            <section>
              ...
              <p className="text-gray-700 leading-relaxed mb-4">
                Permission is granted to temporarily use Elle AI services for
            ...
            <section>
              ...
              <p className="text-gray-700 leading-relaxed mb-4">
                ...
                any purpose prohibited under this clause. You may not use our
                services in any manner that could damage, disable, overburden,
                or impair our servers.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-gray-700 leading-relaxed">
                ...
                functionality are and will remain the exclusive property of Elle
